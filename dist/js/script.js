...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const tabs = document.querySelectorAll(".tabheader__item"),
        ...
        tabsParent = document.querySelector(".tabheader__items"); // var timer

  const deadLine = "2022-05-20"; // var modal window

  const modatTrigger = document.querySelectorAll("[data-modal]"),
        modal = document.querySelector(".modal"),
        modalCloseBtn = document.querySelector("[data-close]"); // Tabs
  ...
  window.addEventListener("scroll", showModalByScroll); // class es6
  ...
  new MenuCard("img/tabs/vegy.jpg", "vegy", 'Меню "Фитнес"', `Меню "Фитнес" - это новый подход к приготовлению блюд:больше
    ...
    абсолютно новый продукт с оптимальной ценой и высоким качеством!`, 40, ".menu .container", "menu__item").render(); //2
  ...
  new MenuCard("img/tabs/elite.jpg", "elite", "Меню “Премиум”", `В меню “Премиум” мы используем не только красивый дизайн упаковки,
    ...
    фрукты - ресторанное меню без похода в ресторан!`, 60, ".menu .container", "menu__item").render(); //3
  ...
  new MenuCard("img/tabs/post.jpg", "post", 'Меню "Постное"', `Меню “Постное” - это тщательный подбор ингредиентов: полное
    ...
    и импортных вегетарианских стейков.`, 50, ".menu .container", "menu__item").render(); //Forms
